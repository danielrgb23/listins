import 'package:listin/widgets/expandable_fab.dart';
...
import 'package:listin/firestore_produtos/screen/produto_screen.dart';
import 'package:listin/authentication/components/show_senha_confirmacao.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      ...
                      // Usar id do model
                      if (model != null) {
                        listin.idListin = model.idListin;
                      }
  ...
  _showListinCode() {
    // Labels à serem mostradas no Modal
    String labelTitle = "Acessar Listin compartilhado";
    String labelConfirmationButton = "Acessar";
    String labelSkipButton = "Fechar";
              ...
              Row(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: () {
                      listinService
                          .findListins(nameController.text)
                          .then((value) => Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                                      ProdutoScreen(listin: value[0]),
                                ),
                              ));
                      // Fechar o Modal
                      Navigator.pop(context);
  ...
  void remove(Listin model) async {
    await listinService.removerListin(listinId: model.idListin);
    refresh();
  }
}
